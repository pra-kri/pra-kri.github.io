...
<table style="width:140%">
  ...
  <tr>
    ...
    <td><details><summary><sup> ...(Read more)</sup></summary>
      <b> Ideal: </b> Build a deep understanding of investing. Where should you allocate capital (and time) in the market? What signals can you use to predict growth and value in companies? Learn from investors in different fields. Value (Buffett, Munger, Klarman...), VC (Paul Graham, Peter Thiel - Zero to One, Tim Ferriss' interviews with a LOT of angel investors), Quants (Taleb, Spitznagel, Thorp, AQR, Winton, ...), Global Macro (Dalio, Soros)...etc. The investing field also seems to be full of interesting writers who stress the importance of <b>wisdom (risk-management, epistemic humility), courage (risk-taking, skin-in-the-game) and independent thinking (filtering signal from noise)</b>. There aren't many other fields where this sort of culture is strongly present. The only others that come to mind are 1.Startups + Silicon Valley, 2.Intelligence + Military Strategy, 3.Medicine, 4.Policy, Risk, Governance. They're all fields where navigating risk and uncertainty are crucial. 
      <br>
