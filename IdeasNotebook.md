...
* **From a Motivation perspective**: Focusing too much on the outcome makes you feel too much pressure, maybe even to the point of putting things off. But instead, if you give yourself permission to screw up and focus on just doing the process properly regardless of the outcome, then suddenly you feel surprisingly free and motivated. *Don't worry about the outcome, focus only on the process and your behaviour.* In a way, that's quite similar to the ideas found in Stoicism.
